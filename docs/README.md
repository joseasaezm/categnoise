...
|&nbsp;&nbsp;&nbsp;**-** *Performance plots of robust algorithms (noisy train / clean test)* | <a href="https://github.com/joseasaezm/categnoise/raw/main/docs/nc_robust.png" target="_blank" rel="noopener noreferrer"><img src="icon-png.png" width="50"></a>|
|&nbsp;&nbsp;&nbsp;**-** *Performance results (noisy train / noisy test)* | <a href="https://github.com/joseasaezm/categnoise/raw/main/docs/nn_results.pdf" target="_blank" rel="noopener noreferrer"><img src="icon-pdf.png" width="50"></a>|
|&nbsp;&nbsp;&nbsp;**-** *Performance evolution plot (noisy train / noisy test)* | <a href="https://github.com/joseasaezm/categnoise/raw/main/docs/nn_plot.png" target="_blank" rel="noopener noreferrer"><img src="icon-png.png" width="50"></a>|
|&nbsp;&nbsp;&nbsp;**-** *Performance plots of robust algorithms (noisy train / noisy test)* | <a href="https://github.com/joseasaezm/categnoise/raw/main/docs/nn_robust.png" target="_blank" rel="noopener noreferrer"><img src="icon-png.png" width="50"></a>|
|<a href="#img1"><img src="bannercolor.jpg" width="750" height="10"></a>|<a href="#img1"><img src="bannercolor.jpg" width="100" height="10"></a>|
